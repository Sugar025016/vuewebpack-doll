  ...
  <div>
    ...
    <main role="main">
      ...
      >
          ...
          <div class="carousel-item">
            ...
            <div
              ...
              style="
                ...
                background-image: url('http://localhost:8082/16348130439051455.png');
              "
        ...
        <button
          class="carousel-control-prev btn-primary-outline"
          type="button"
        ...
        <button
          class="carousel-control-next btn-primary-outline"
          type="button"
          data-target="#myCarousel"
          data-slide="next"
        >
...
export default {
  data() {
    return {
      i: 0,
      imageUrl: "http://localhost:8082/16348130439051456.jpg",
    };
  },
};
</script>
...
@import "../../assets/_searchShopBoard";
.bd-placeholder-img {
  font-size: 1.125rem;
  text-anchor: middle;
